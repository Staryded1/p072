...
class newfilm extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    newfilm.MyTask mt;
    newfilm.MyTaskN mtn;
...
//        lvMain.getCheckedItemPositions();
    ...
    class MyTaskTF extends AsyncTask<String, Void, Void > {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/kinoo/");
                myConnection =
...
//                tvInfo.setText(str);
    ...
    class MyTaskN extends AsyncTask<String, Void, String >{
        ...
        protected String doInBackground(String... params) {
            ...
            myConnection.setDoOutput(true);
            try {
                myConnection.getOutputStream().write( ("id=2&nazvanie=" + params[0]).getBytes());
            } catch (IOException e) {
                e.printStackTrace();
            };
